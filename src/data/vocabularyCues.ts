export const vocabularyCues = [
  {
    pronunciation: "LOO-sid · adjective",
    type: "Sound hook",
    hook: "LOOSE LID",
  ...
  },
  {
    ...
    type: "Picture hook",
    hook: "A vault of rice",
    caption: "A kingdom of rice. Not one grain to share. That is AVARICE.",
    story:
      "The rice king hugs a vault of golden grains while everyone else holds an empty bowl. Avarice means excessive greed for wealth.",
  },
  {
  ...
  },
  {
    ...
    type: "Meaning hook",
    hook: "Practical beats magical",
    caption: "The PRAGMATIC wizard reaches for a ladder.",
    story:
      "A wizard cannot make his fancy wand work. He uses an ordinary ladder to reach the book instead. Pragmatic means focused on practical solutions.",
  },
  {
    pronunciation: "tuh-NAY-shus · adjective",
    type: "Sound hook",
    hook: "TEN ACES",
    caption: "Imagine TEN ACES in a TENACIOUS grip.",
    story:
      "Imagine an impossible hand of ten aces. The poker player holds on through a gale while everything else flies away. Tenacious means persistent and unwilling to give up.",
  },
  {
    pronunciation: "ih-LOO-siv · adjective",
    type: "Sound hook",
    hook: "An EEL is LOOSE",
    caption: "The EEL is LOOSE. This ELUSIVE escape artist is gone.",
    story:
      "An eel escapes its aquarium on roller skates. The scientist keeps catching empty air. Elusive means difficult to catch, find or pin down.",
  },
];
