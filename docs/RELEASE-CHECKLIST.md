...
- [ ] Follow docs/GO-LIVE.md: apply the AI gateway migration and deploy the `ai` function. Complete a RevenueCat Billing sandbox purchase on the web, then confirm the AI tutor, AI quizzes (text and PDF), personalized stories and new memory hooks work, that a non-Plus account is refused, and that the quota applies.
